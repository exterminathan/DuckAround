...
Shader "DuckEyeHolo"
{
	Properties
	{
		...
		_FresnelScale("Fresnel Scale", Float) = 7
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float fresnelNode11 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV11, 5.0 ) );
				float4 color14 = IsGammaSpace() ? float4(0.2051887,0.4947899,0.8207547,0) : float4(0.03474451,0.2092504,0.6396053,0);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( fresnelNode11 * color14 ).rgb;
				float Alpha = 1;
